// File taken from https://github.com/excalidraw/excalidraw/blob/master/src/excalidraw-app/collab/reconciliation.ts
...
import { PRECEDING_ELEMENT_KEY } from '../config/constants';
